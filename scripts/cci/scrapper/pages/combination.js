...
import { getPdfCombination } from "../helpers/getPdfCombination.js";
...
const scrapeAllPdfPages = async () => {
  ...
  const baseURL = "https://www.cci.gov.in/combination";
  const urlQueue = new Set(["https://www.cci.gov.in/combination/legal-framwork/act"]);
