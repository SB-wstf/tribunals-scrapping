...
import { getPdfLegalFramwork } from "../helpers/getPdfLegalFramwork.js";
...
const scrapeAllPdfPages = async () => {
  ...
  const baseURL = "https://www.cci.gov.in/legal-framwork";
  const urlQueue = new Set(["https://www.cci.gov.in/legal-framwork/act"]);
