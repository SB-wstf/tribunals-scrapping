...
import { getPdfcapacitybuilding } from "../helpers/getPdfcapacitybuilding.js";
...
const scrapeAllPdfPages = async () => {
  ...
  const baseURL = "https://www.cci.gov.in/capacity-building";
  const urlQueue = new Set(["https://www.cci.gov.in/capacity-building"]);
