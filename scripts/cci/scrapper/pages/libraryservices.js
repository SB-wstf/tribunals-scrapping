...
import { getPdflibraryservices } from "../helpers/getPdflibraryservices.js";
...
const scrapeAllPdfPages = async () => {
  ...
  const baseURL = "https://www.cci.gov.in/library-services";
  const urlQueue = new Set(["https://www.cci.gov.in/library-services"]);
