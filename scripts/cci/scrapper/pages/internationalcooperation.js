...
import { getPdfinternationalcooperation } from "../helpers/getPdfinternationalcooperation.js";
...
const scrapeAllPdfPages = async () => {
  ...
  const baseURL = "https://www.cci.gov.in/international-cooperation";
  const urlQueue = new Set(["https://www.cci.gov.in/international-cooperation/abouts"]);
  ...
  while (urlQueue.size > 0) {
    ...
    if (!visitedUrls.has(currentUrl)) {
      ...
      await getPdfinternationalcooperation(
        currentUrl,
        page,
        urlQueue,
        visitedUrls,
